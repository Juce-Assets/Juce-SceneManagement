    ...
    public static class ComponentHeaderDrawer
    {
            ...
            )
        {
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                EditorGUI.DrawRect(currentInteractionRect, SceneGroupEditorStyle.ReorderColor);
            }
            ...
            if (canBeDisabled)
            {
                ...
                // Active checkbox
                enabled = GUI.Toggle(toggleRect, enabled, GUIContent.none, SceneGroupEditorStyle.SmallTickbox);
